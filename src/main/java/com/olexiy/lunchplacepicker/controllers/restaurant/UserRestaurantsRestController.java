...
@RestController
@RequestMapping(value = "/rest/profile/restaurants", produces = MediaType.APPLICATION_JSON_VALUE)
public class UserRestaurantsRestController extends AbstractRestaurantController {
