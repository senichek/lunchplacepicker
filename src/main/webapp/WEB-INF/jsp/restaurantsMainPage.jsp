...
<div class="container-fluid">
    <a href="menus" class="btn btn-info float-left mr-1" id="menusBtn">Menus</a>
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <a class="dropdown-item" href="restaurants?sort=desc" id="fromMoreToLess">From more to less</a>
            <a class="dropdown-item" href="restaurants?sort=asc" id="fromLessToMore">From less to more</a>
        </div>
...
<div class="modal fade" id="showMenuModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="showMenuModalLabel"></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="menuDescription">
                ...
            </div>
