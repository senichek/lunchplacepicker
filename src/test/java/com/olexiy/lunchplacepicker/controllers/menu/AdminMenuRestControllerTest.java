...
public class AdminMenuRestControllerTest extends AbstractRestControllerTest {
    ...
    private final String FOLDER_NAME = "restControllers/AdminMenuRestController/";

    @Test
    public void getAll() throws Exception {
        super.getMockMvc().perform(get(APP_CONTEXT + "/rest/admin/menus/")
    ...
    public void getAllWithLikes() throws Exception {
        super.getMockMvc().perform(get(APP_CONTEXT + "/rest/admin/menus/likes")
                .contextPath(APP_CONTEXT)
                .with(httpBasic("admin@gmail.com", "admin")))
                .andExpect(status().isOk())
                .andDo(document(FOLDER_NAME + "{methodName}",
    ...
    public void getByID() throws Exception {
        ...
        super.getMockMvc().perform(get(APP_CONTEXT + "/rest/admin/menus/{id}", 100010)
                .contextPath(APP_CONTEXT)
                .with(httpBasic("admin@gmail.com", "admin")))
                .andExpect(status().isOk())
    ...
    public void save() throws Exception {
        ...
        super.getMockMvc().perform(post(APP_CONTEXT + "/rest/admin/menus/{restaurantId}", RestaurantTestData.rest5.getId())
                .contextPath(APP_CONTEXT)
                .with(httpBasic("admin@gmail.com", "admin"))
    ...
    public void delete() throws Exception {
        super.getMockMvc().perform(MockMvcRequestBuilders
                .delete(APP_CONTEXT + "/rest/admin/menus/{id}", 100010)
                .contextPath(APP_CONTEXT)
                .with(httpBasic("admin@gmail.com", "admin"))
    ...
    public void getMenusByRestaurantId() throws Exception {
        super.getMockMvc().perform(get(APP_CONTEXT + "/rest/admin/menus/100002/all")
                .contextPath(APP_CONTEXT)
                .with(httpBasic("admin@gmail.com", "admin")))
                .andExpect(status().isOk())
                .andDo(document(FOLDER_NAME + "{methodName}",
    ...
    public void getMenusByRestaurantIdWithLikes() throws Exception {
        super.getMockMvc().perform(get(APP_CONTEXT + "/rest/admin/menus/100002/all/likes")
                .contextPath(APP_CONTEXT)
                .with(httpBasic("admin@gmail.com", "admin")))
                .andExpect(status().isOk())
                .andDo(document(FOLDER_NAME + "{methodName}",
